...
(
    ...
    CONSTRAINT pk_permission_description PRIMARY KEY(permission_id, code),
...
(
    ...
    CONSTRAINT fk_form_status_description_form_status FOREIGN KEY (status_id) REFERENCES form_status(status_id) ON DELETE CASCADE ON UPDATE CASCADE
);

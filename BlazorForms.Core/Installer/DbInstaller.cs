...
namespace BlazorForms.Installer.Core
{
...
(
	...
	FOREIGN KEY (permission_id) REFERENCES permissions(permission_id) ON DELETE CASCADE ON UPDATE CASCADE
            ...
            _tables.Add(new SqlTable("user_filter", @"
...
(
	...
	notify_creator TINYINT NOT NULL DEFAULT 0,
	notify_managers TINYINT NOT NULL DEFAULT 0,
	notify_approvers TINYINT NOT NULL DEFAULT 0,
